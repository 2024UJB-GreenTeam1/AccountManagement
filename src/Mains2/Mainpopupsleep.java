...
public class Mainpopupsleep {
	...
	public static void main(String[] args) {
		...
		todaysleepText.setLocation(250, 355);
		todaysleepText.setFont(font1);
		
		todaysleepText2.setSize(50, 25);
		todaysleepText2.setLocation(360, 355);
		todaysleepText2.setFont(font1);
		//기상
		todaygetupText.setSize(50, 25);
		todaygetupText.setLocation(250, 400);
		todaygetupText.setFont(font1);
		
		todaygetupText2.setSize(50, 25);
		todaygetupText2.setLocation(360, 400);
		todaygetupText2.setFont(font1);
		//계산 필드
		todaysleeplastText.setSize(120, 25);
		todaysleeplastText.setLocation(340, 465);
		todaysleeplastText.setFont(font1);
		
		//버튼
		Button todaysleepbutton = new Button("완료");

		todaysleepbutton.setSize(80, 40);
		todaysleepbutton.setLocation(285, 540);
		todaysleepbutton.setFont(font2);
		
		Button todaysleepbutton2 = new Button("입력");
		
		// 버튼 이벤트 리스너 추가
		todaysleepbutton2.addActionListener(new ActionListener() {
		    @Override
		    public void actionPerformed(ActionEvent e) {
		     
		        int sleepHour = Integer.parseInt(todaysleepText.getText());
		        int sleepMinute = Integer.parseInt(todaysleepText2.getText());
		        int wakeHour = Integer.parseInt(todaygetupText.getText());
		        int wakeMinute = Integer.parseInt(todaygetupText2.getText());

		        // 시간 계산
		        int totalSleepMinutes = ((wakeHour * 60 + wakeMinute) - (sleepHour * 60 + sleepMinute));
		        if (totalSleepMinutes < 0) {
		            totalSleepMinutes += 1440; // 하루가 넘어간 경우 (24시간 = 1440분 추가)
		        }
		        ...
		        todaysleeplastText.setText(hours + "시간 " + minutes + "분");
		    }
		});

		
		todaysleepbutton2.setSize(60, 75);
		todaysleepbutton2.setLocation(450, 350);
		todaysleepbutton2.setFont(font1);
