...
public class Mainpopupfood {
	...
	public static void main(String[] args) {
		...
		// 텍스트
		TextField mykcaltext2 = new TextField(7);

		mykcaltext2.setSize(70, 25);
		mykcaltext2.setLocation(165, 675);
		mykcaltext2.setFont(font1);
		...
		Label foodference1 = new Label("총 칼로리 값");
		...
		foodference1.setSize(110, 40);
		foodference1.setLocation(45, 670);
		foodference1.setFont(font1);
		...
		foodsccbutton.addActionListener(new ActionListener() {
		    public void actionPerformed(ActionEvent e) {
		        try {
		            ...
		            mykcaltext2.setText(String.valueOf(sum));
		        } catch (NumberFormatException nfe) {
		        	mykcaltext2.setText("error");
		        }
		    }
		});
